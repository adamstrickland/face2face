...
function addAutoCompleteBehaviors() {
	$('.timeautocomplete').autocomplete(buildTimeOptions()); // , { minChars: 2 } -- requires the minChar bugfix to work
	$('.whatautocomplete').autocomplete(eventNames);
